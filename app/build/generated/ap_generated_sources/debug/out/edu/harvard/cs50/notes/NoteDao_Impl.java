...
public final class NoteDao_Impl implements NoteDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfDelete_note;
  ...
  public NoteDao_Impl(RoomDatabase __db) {
    ...
    this.__preparedStmtOfDelete_note = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
  ...
  public void delete_note(final int id) {
    __db.assertNotSuspendingTransaction();
    final SupportSQLiteStatement _stmt = __preparedStmtOfDelete_note.acquire();
    int _argIndex = 1;
    _stmt.bindLong(_argIndex, id);
    __db.beginTransaction();
    try {
      ...
      __db.endTransaction();
      __preparedStmtOfDelete_note.release(_stmt);
    }
  }
